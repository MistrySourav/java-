...
{	
	...
	public void actionPerformed(ActionEvent e1)
	{
		...
		else if(e1.getSource()==loginBtn1)
		{
			...
			if(s1.equals("Redwan") && s2.equals("1234") || s1.equals("Sakib") && s2.equals("1234") || s1.equals("Sourav") && s2.equals("1234"))
			{
				Employee2 t131= new Employee2();
				t131.setVisible(true);
				this.setVisible(false);
			}
            else
            {
		...
		{
			Contacts cc1a = new Contacts();
			cc1a.setVisible(true);
			this.setVisible(false);
		}
