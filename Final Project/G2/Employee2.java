...
{	
	...
	public void actionPerformed(ActionEvent e2)
	{
		...
		{
			vehicale vss145 = new vehicale();
			vss145.setVisible(true);
		...
		{
			Employee cscc2 = new Employee();
			cscc2.setVisible(true);
			this.setVisible(false);
		}
